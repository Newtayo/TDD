...
```sh
  cd my-folder
  https://github.com/brhanuhailu/TDD-project.git
```
...
Feel free to check the [issues page](https://github.com/brhanuhailu/TDD-project/issues).
...
- This project is [MIT](https://github.com/brhanuhailu/TDD-project/blob/dev/LICENSE) licensed.
